...
with open('../../../results/sort/radixsort/min_chunk_size.csv', 'r') as f:
    data = f.read()
...
ax.set_title('Time vs Minimum Chunk Size (n = 10,000,000)')
...
fig.savefig('../../../results/sort/radixsort/min_chunk_size.png')